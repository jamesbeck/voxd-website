...
function getStages(businessName: string): Stage[] {
  return [
    {
      id: "user-sends",
      step: 1,
    ...
    },
    {
      ...
      icon: Server,
      color: "bg-blue-500",
      description: `Meta's official WhatsApp Business API receives the message and triggers a secure webhook to notify ${businessName}.`,
      details: [
        "Enterprise-grade infrastructure with 99.9% uptime",
        "End-to-end encryption maintained throughout",
        `Webhook notification sent to ${businessName} servers in milliseconds`,
    ...
    },
    {
      id: "voxd-processes",
      step: 3,
      title: `${businessName} Processes Message`,
      subtitle: "Context enrichment & orchestration",
      icon: Database,
      color: "bg-primary",
      description: `${businessName} receives the webhook, queues the message, and enriches it with context from your business systems.`,
      details: [
    ...
    },
    {
      ...
      icon: Plug,
      color: "bg-orange-500",
      description: `${businessName} connects to your business systems to fetch real-time data, ensuring the AI has accurate, up-to-date information.`,
      details: [
        ...
        `All connections are managed securely by ${businessName} — the AI never connects directly to your systems`,
      ],
    },
    {
      id: "ai-generates",
    ...
    },
    {
      id: "voxd-validates",
      step: 5,
      title: `${businessName} Validates Response`,
      subtitle: "Quality control & tool execution",
      icon: Cpu,
      color: "bg-primary",
      description: `${businessName} receives the AI response, executes any tool calls (like booking an appointment), and validates the output.`,
      details: [
    ...
    },
    {
      ...
      icon: Send,
      color: "bg-blue-500",
      description: `${businessName} sends the response back through Meta's WhatsApp Business API for delivery to the user.`,
      details: [
