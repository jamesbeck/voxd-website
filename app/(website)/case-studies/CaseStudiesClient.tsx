...
interface CaseStudiesClientProps {
  examples: Example[];
  industries: { id: string; name: string; slug: string; exampleCount: string }[];
  functions: { id: string; name: string; slug: string; functionCount: string }[];
}
        ...
        {filteredExamples.map((example) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              {/* Short Description */}
              <p className="text-gray-600 mb-4 line-clamp-3">{example.short}</p>
