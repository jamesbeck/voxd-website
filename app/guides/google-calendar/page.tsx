    ...
    <PartnerGuideShell partner={partner}>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4 space-y-3">
            ...
            <div className="space-y-2">
              <div>
                <span className="text-gray-500 text-sm">Application name:</span>
              ...
              <div>
                <span className="text-gray-500 text-sm">Scopes required:</span>
                ...
                <p className="text-gray-500 text-xs mt-1">
                  (email and profile are standard OpenID scopes and are required
          ...
          <div>
            ...
            <div className="space-y-2 ml-4">
              ...
              <div className="flex gap-2">
                ...
                <span className="text-gray-700">your admin email address</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-gray-50 rounded-lg p-4 space-y-3">
          ...
          <div className="space-y-2 ml-4">
            <div className="flex gap-2">
              ...
              <code className="bg-white px-1 rounded">Chatbot Integration</code>
            </div>
            <div>
              <span className="text-gray-500">Authorized redirect URIs:</span>
      ...
      <section className="bg-white rounded-xl shadow-sm p-6 space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <p className="font-medium text-gray-900 mb-2">Helpful (optional)</p>
