...
import saUpdateFaq from "@/actions/saUpdateFaq";
...
export default function EditFaqForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      question: question || "",
      answer: answer || "",
      partnersOnly: partnersOnly ?? false,
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const response = await saUpdateFaq({
      faqId,
    ...
    if (!response.success) {
      toast.error(response.error || "Failed to update FAQ");
      setLoading(false);
      return;
    }
