...
import saUploadExampleHeroImage from "@/actions/saUploadExampleHeroImage";
import saGenerateExampleHeroImage from "@/actions/saGenerateExampleHeroImage";
...
export default function ExampleHeroImageTab({
  exampleId,
  ...
  const existingHeroImageUrl = heroImageFileExtension
    ? `https://${
      ...
      }/voxd/exampleImages/${exampleId}.${heroImageFileExtension}${
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        const result = await saUploadExampleHeroImage({
          exampleId,
          fileBase64: base64,
  ...
  const handleGenerateHeroImage = async () => {
    ...
    try {
      const result = await saGenerateExampleHeroImage({
        exampleId,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold mb-2">Example Hero Image</h2>
        <p className="text-sm text-muted-foreground">
          Upload a hero image for this example or generate one using AI. The
          hero image will be displayed as the banner on the example page.
        </p>
      </div>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                ...
                the example details. You can optionally provide additional
                guidance below.
              </DialogDescription>
            </DialogHeader>
